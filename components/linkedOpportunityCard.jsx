...
import LinkedOpportunityForm from "./linkedOpportunityForm";
import Link from '@mui/material/Link';
const LinkedOpportunityCards = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <h2 className="text-3xl font-bold text-gray-800">Linked Opportunities</h2>
        <button 
            ...
            >
              <div className="p-6">
                ...
                <div className="flex items-center text-gray-600 mb-3">
                  ...
                  <Link href={opportunity.link} underline="always">
                  {opportunity.link}
                    </Link>
                </div>
...
export default LinkedOpportunityCards;
